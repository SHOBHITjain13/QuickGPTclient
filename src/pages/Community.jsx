      ...
      {images.length >0 ? (
        <div className='flex flex-wrap max-sm:justify-center gap-5'>
          {images.map((item, index)=> (
            ...
            rounded-lg overflow-hidden border border-gray-200 dark:border-purple-700 shadow-sm
        ...
        <p className='text-center text-gray-600 dark:tetx-purple-200 mt-10'>No Images Available.</p>
      )}
    </div>
  )
}
